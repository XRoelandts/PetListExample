...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pets.add(new Pet( "Doug", "Mastiff", 2));
        pets.add(new Pet( "Sheila", "Doberman", 5));
        pets.add(new Pet( "Mutt", "Poodle", ran.nextInt()));
    ...
    private void useStringResource() {
        ...
        ArrayAdapter adapter = new ArrayAdapter(this, android.R.layout.simple_expandable_list_item_1, contents);
